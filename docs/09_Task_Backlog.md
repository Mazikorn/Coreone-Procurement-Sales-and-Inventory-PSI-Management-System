...
| ID | 任务 | 来源 | 影响范围 |
|----|------|------|----------|
| TASK-P0-001 | 退库管理前端页面缺失（后端已有） | 功能补全 PAGE-P0-01 | 退库模块不可用 |
| TASK-P0-002 | 报废管理前端页面缺失（后端已有） | 功能补全 PAGE-P0-02 | 报废模块不可用 |
| TASK-P0-003 | 调拨管理前端页面缺失（后端已有） | 功能补全 PAGE-P0-03 | 调拨模块不可用 |
| TASK-P0-004 | 供应商退货管理前端页面缺失 | 功能补全 PAGE-P1-02 | 供应商退货不可用 |
...
| TASK-P1-003 | 采购订单无独立页面 | 功能补全 PAGE-P1-01 | 采购全流程 |
