...
function seedInboundRecords(db: any) {
  ...
  const inbounds = [
    // === 苏木素染液 - 3个批次 ===
    { id: 'IB-001', material_id: 'MAT-HE-001', batch_no: 'DAKO-HE-20260115-A', quantity: 5, price: 180, supplier_id: 'SUP-003', location_id: 'LOC-A01', production_date: '2026-01-15', expiry_date: '2027-01-15', operator: '赵慧萍', purchase_order_id: 'PO-001' },
    { id: 'IB-002', material_id: 'MAT-HE-001', batch_no: 'DAKO-HE-20260320-B', quantity: 3, price: 185, supplier_id: 'SUP-003', location_id: 'LOC-A01', production_date: '2026-03-20', expiry_date: '2027-03-20', operator: '赵慧萍', purchase_order_id: 'PO-001' },
    { id: 'IB-003', material_id: 'MAT-HE-001', batch_no: 'DAKO-HE-20260510-C', quantity: 2, price: 190, supplier_id: 'SUP-003', location_id: 'LOC-A01', production_date: '2026-05-10', expiry_date: '2027-05-10', operator: '赵慧萍', purchase_order_id: 'PO-001' },

    // === 伊红染液 - 2个批次 ===
    { id: 'IB-004', material_id: 'MAT-HE-002', batch_no: 'LEICA-HE-20260201-A', quantity: 6, price: 120, supplier_id: 'SUP-003', location_id: 'LOC-A01', production_date: '2026-02-01', expiry_date: '2027-02-01', operator: '赵慧萍', purchase_order_id: 'PO-002' },
    { id: 'IB-005', material_id: 'MAT-HE-002', batch_no: 'LEICA-HE-20260508-B', quantity: 4, price: 125, supplier_id: 'SUP-003', location_id: 'LOC-A01', production_date: '2026-05-08', expiry_date: '2027-05-08', operator: '赵慧萍', purchase_order_id: 'PO-002' },

    // === 分化液/返蓝液 ===
    { id: 'IB-006', material_id: 'MAT-HE-003', batch_no: 'LEICA-HE-20260401', quantity: 3, price: 80, supplier_id: 'SUP-003', location_id: 'LOC-A01', production_date: '2026-04-01', expiry_date: '2027-04-01', operator: '赵慧萍', purchase_order_id: null },
    { id: 'IB-007', material_id: 'MAT-HE-004', batch_no: 'LEICA-HE-20260401', quantity: 3, price: 60, supplier_id: 'SUP-003', location_id: 'LOC-A01', production_date: '2026-04-01', expiry_date: '2027-04-01', operator: '赵慧萍', purchase_order_id: null },

    // === 乙醇/二甲苯 (PO-012 ordered_qty=20) ===
    { id: 'IB-008', material_id: 'MAT-HE-005', batch_no: 'SINOPHARM-20260501', quantity: 15, price: 25, supplier_id: 'SUP-009', location_id: 'LOC-F01', production_date: '2026-05-01', expiry_date: '2028-05-01', operator: '赵慧萍', purchase_order_id: 'PO-012' },
    { id: 'IB-008b', material_id: 'MAT-HE-005', batch_no: 'SINOPHARM-20260508', quantity: 5, price: 25, supplier_id: 'SUP-009', location_id: 'LOC-F01', production_date: '2026-05-08', expiry_date: '2028-05-08', operator: '赵慧萍', purchase_order_id: 'PO-012' },
    { id: 'IB-009', material_id: 'MAT-HE-006', batch_no: 'SINOPHARM-20260501', quantity: 12, price: 20, supplier_id: 'SUP-009', location_id: 'LOC-F01', production_date: '2026-05-01', expiry_date: '2028-05-01', operator: '赵慧萍', purchase_order_id: null },
    { id: 'IB-010', material_id: 'MAT-HE-007', batch_no: 'SINOPHARM-20260501', quantity: 8, price: 35, supplier_id: 'SUP-009', location_id: 'LOC-F01', production_date: '2026-05-01', expiry_date: '2028-05-01', operator: '赵慧萍', purchase_order_id: null },

    // === 石蜡/树胶 ===
    { id: 'IB-011', material_id: 'MAT-HE-008', batch_no: 'SINOPHARM-20260415', quantity: 3, price: 150, supplier_id: 'SUP-009', location_id: 'LOC-B01', production_date: '2026-04-15', expiry_date: '2029-04-15', operator: '赵慧萍', purchase_order_id: null },
    { id: 'IB-012', material_id: 'MAT-HE-009', batch_no: 'LEICA-HE-20260310', quantity: 5, price: 90, supplier_id: 'SUP-003', location_id: 'LOC-A01', production_date: '2026-03-10', expiry_date: '2027-03-10', operator: '赵慧萍', purchase_order_id: null },

    // === IHC抗体 - 多批次，高价值 ===
    { id: 'IB-013', material_id: 'MAT-IHC-001', batch_no: 'DAKO-IHC-20260301-A', quantity: 2, price: 1200, supplier_id: 'SUP-001', location_id: 'LOC-C01', production_date: '2026-03-01', expiry_date: '2027-03-01', operator: '赵慧萍', purchase_order_id: 'PO-003' },
    { id: 'IB-014', material_id: 'MAT-IHC-001', batch_no: 'DAKO-IHC-20260505-B', quantity: 1, price: 1250, supplier_id: 'SUP-001', location_id: 'LOC-C01', production_date: '2026-05-05', expiry_date: '2027-05-05', operator: '赵慧萍', purchase_order_id: 'PO-003' },

    { id: 'IB-015', material_id: 'MAT-IHC-021', batch_no: 'DAKO-IHC-20260301-A', quantity: 2, price: 1350, supplier_id: 'SUP-001', location_id: 'LOC-C01', production_date: '2026-03-01', expiry_date: '2027-03-01', operator: '赵慧萍', purchase_order_id: 'PO-004' },
    { id: 'IB-016', material_id: 'MAT-IHC-021', batch_no: 'DAKO-IHC-20260505-B', quantity: 1, price: 1380, supplier_id: 'SUP-001', location_id: 'LOC-C01', production_date: '2026-05-05', expiry_date: '2027-05-05', operator: '赵慧萍', purchase_order_id: 'PO-004' },

    { id: 'IB-017', material_id: 'MAT-IHC-049', batch_no: 'DAKO-IHC-20260301-A', quantity: 2, price: 1100, supplier_id: 'SUP-001', location_id: 'LOC-C01', production_date: '2026-03-01', expiry_date: '2027-03-01', operator: '赵慧萍', purchase_order_id: 'PO-005' },
    { id: 'IB-018', material_id: 'MAT-IHC-049', batch_no: 'DAKO-IHC-20260505-B', quantity: 1, price: 1150, supplier_id: 'SUP-001', location_id: 'LOC-C01', production_date: '2026-05-05', expiry_date: '2027-05-05', operator: '赵慧萍', purchase_order_id: 'PO-005' },

    { id: 'IB-019', material_id: 'MAT-IHC-055', batch_no: 'DAKO-IHC-20260420', quantity: 2, price: 1500, supplier_id: 'SUP-001', location_id: 'LOC-C01', production_date: '2026-04-20', expiry_date: '2027-04-20', operator: '赵慧萍', purchase_order_id: 'PO-006' },
    { id: 'IB-020', material_id: 'MAT-IHC-059', batch_no: 'VENTANA-IHC-20260425', quantity: 2, price: 2800, supplier_id: 'SUP-002', location_id: 'LOC-C01', production_date: '2026-04-25', expiry_date: '2027-04-25', operator: '赵慧萍', purchase_order_id: 'PO-007' },

    // === 分子诊断试剂 ===
    { id: 'IB-021', material_id: 'MAT-MP-001', batch_no: 'THERMO-MP-20260501', quantity: 2, price: 1800, supplier_id: 'SUP-004', location_id: 'LOC-D01', production_date: '2026-05-01', expiry_date: '2027-05-01', operator: '赵慧萍', purchase_order_id: 'PO-008' },
    { id: 'IB-022', material_id: 'MAT-MP-004', batch_no: 'ROCHE-MP-20260501', quantity: 5, price: 850, supplier_id: 'SUP-005', location_id: 'LOC-D02', production_date: '2026-05-01', expiry_date: '2027-05-01', operator: '赵慧萍', purchase_order_id: 'PO-009' },

    // === 玻片 ===
    { id: 'IB-023', material_id: 'MAT-GLASS-001', batch_no: 'LEICA-GL-20260501', quantity: 10, price: 180, supplier_id: 'SUP-003', location_id: 'LOC-B01', production_date: '2026-05-01', expiry_date: '2029-05-01', operator: '赵慧萍', purchase_order_id: 'PO-010' },
    { id: 'IB-024', material_id: 'MAT-GLASS-001', batch_no: 'LEICA-GL-20260508', quantity: 10, price: 185, supplier_id: 'SUP-003', location_id: 'LOC-B01', production_date: '2026-05-08', expiry_date: '2029-05-08', operator: '赵慧萍', purchase_order_id: 'PO-010' },

    // === 手套/防护用品 (PO-011 ordered_qty=30, 需要两笔入库) ===
    { id: 'IB-025', material_id: 'MAT-LAB-010', batch_no: 'YUHUA-LAB-20260501', quantity: 15, price: 65, supplier_id: 'SUP-010', location_id: 'LOC-B02', production_date: '2026-05-01', expiry_date: '2031-05-01', operator: '赵慧萍', purchase_order_id: 'PO-011' },
    { id: 'IB-025b', material_id: 'MAT-LAB-010', batch_no: 'YUHUA-LAB-20260508', quantity: 15, price: 65, supplier_id: 'SUP-010', location_id: 'LOC-B02', production_date: '2026-05-08', expiry_date: '2031-05-08', operator: '赵慧萍', purchase_order_id: 'PO-011' },
    { id: 'IB-026', material_id: 'MAT-LAB-011', batch_no: 'YUHUA-LAB-20260501', quantity: 15, price: 65, supplier_id: 'SUP-010', location_id: 'LOC-B02', production_date: '2026-05-01', expiry_date: '2031-05-01', operator: '赵慧萍', purchase_order_id: null },

    // === 固定液 (PO-013 ordered_qty=10, 补第二笔入库) ===
    { id: 'IB-027', material_id: 'MAT-FIX-001', batch_no: 'SINOPHARM-FIX-20260501', quantity: 8, price: 85, supplier_id: 'SUP-009', location_id: 'LOC-F01', production_date: '2026-05-01', expiry_date: '2028-05-01', operator: '赵慧萍', purchase_order_id: 'PO-013' },
    { id: 'IB-027b', material_id: 'MAT-FIX-001', batch_no: 'SINOPHARM-FIX-20260508', quantity: 2, price: 85, supplier_id: 'SUP-009', location_id: 'LOC-F01', production_date: '2026-05-08', expiry_date: '2028-05-08', operator: '赵慧萍', purchase_order_id: 'PO-013' },

    // === 细胞学 (PO-014 ordered_qty=3) ===
    { id: 'IB-028', material_id: 'MAT-CYTO-005', batch_no: 'BD-CYTO-20260501', quantity: 3, price: 1200, supplier_id: 'SUP-008', location_id: 'LOC-E02', production_date: '2026-05-01', expiry_date: '2027-05-01', operator: '赵慧萍', purchase_order_id: 'PO-014' },

    // === 设备耗材 (PO-015 ordered_qty=5) ===
    { id: 'IB-029', material_id: 'MAT-DEV-001', batch_no: 'LEICA-DEV-20260501', quantity: 3, price: 350, supplier_id: 'SUP-003', location_id: 'LOC-G01', production_date: '2026-05-01', expiry_date: '2031-05-01', operator: '赵慧萍', purchase_order_id: 'PO-015' },
    { id: 'IB-029b', material_id: 'MAT-DEV-001', batch_no: 'LEICA-DEV-20260508', quantity: 2, price: 350, supplier_id: 'SUP-003', location_id: 'LOC-G01', production_date: '2026-05-08', expiry_date: '2031-05-08', operator: '赵慧萍', purchase_order_id: 'PO-015' },

    // === 临期物料（有效期预警） ===
    { id: 'IB-030', material_id: 'MAT-IHC-002', batch_no: 'DAKO-IHC-20250601-OLD', quantity: 1, price: 1150, supplier_id: 'SUP-001', location_id: 'LOC-C01', production_date: '2025-06-01', expiry_date: '2026-05-16', operator: '赵慧萍', purchase_order_id: null },
    { id: 'IB-031', material_id: 'MAT-IHC-003', batch_no: 'DAKO-IHC-20250601-OLD', quantity: 1, price: 1180, supplier_id: 'SUP-001', location_id: 'LOC-C01', production_date: '2025-06-01', expiry_date: '2026-05-14', operator: '赵慧萍', purchase_order_id: null },

    // === 已过期物料（过期预警） ===
    { id: 'IB-032', material_id: 'MAT-IHC-004', batch_no: 'DAKO-IHC-20240501-EXP', quantity: 1, price: 1220, supplier_id: 'SUP-001', location_id: 'LOC-C01', production_date: '2024-05-01', expiry_date: '2025-05-01', operator: '赵慧萍', purchase_order_id: null },

    // === 低库存物料（低库存预警） ===
    { id: 'IB-033', material_id: 'MAT-IHC-005', batch_no: 'DAKO-IHC-20260101', quantity: 1, price: 1100, supplier_id: 'SUP-001', location_id: 'LOC-C01', production_date: '2026-01-01', expiry_date: '2027-01-01', operator: '赵慧萍', purchase_order_id: null },
  ]
...
function seedOutboundRecords(db: any) {
  ...
  const outbounds = [
    // === HE染色项目出库 ===
    { id: 'OB-001', type: 'project', project_id: 'PRJ-HE-001', total_cost: 0, operator: '张伟', remark: '常规HE染色-每日例检' },
    { id: 'OB-002', type: 'project', project_id: 'PRJ-HE-001', total_cost: 0, operator: '张伟', remark: '常规HE染色-每日例检' },
    { id: 'OB-003', type: 'project', project_id: 'PRJ-HE-001', total_cost: 0, operator: '李娜', remark: '常规HE染色-每日例检' },

    // === IHC项目出库 ===
    { id: 'OB-004', type: 'project', project_id: 'PRJ-IHC-001', total_cost: 0, operator: '张伟', remark: '广谱CK检测-乳腺癌标本' },
    { id: 'OB-005', type: 'project', project_id: 'PRJ-IHC-002', total_cost: 0, operator: '张伟', remark: 'CD20检测-淋巴瘤标本' },
    { id: 'OB-006', type: 'project', project_id: 'PRJ-IHC-003', total_cost: 0, operator: '李娜', remark: 'Ki-67检测-胃癌标本' },
    { id: 'OB-007', type: 'project', project_id: 'PRJ-IHC-004', total_cost: 0, operator: '张伟', remark: 'HER2检测-乳腺癌标本' },
    { id: 'OB-008', type: 'project', project_id: 'PRJ-IHC-005', total_cost: 0, operator: '李娜', remark: 'PD-L1检测-肺癌标本' },

    // === 分子诊断项目出库 ===
    { id: 'OB-009', type: 'project', project_id: 'PRJ-MP-001', total_cost: 0, operator: '张伟', remark: 'NGS-425基因Panel-结直肠癌' },
    { id: 'OB-010', type: 'project', project_id: 'PRJ-MP-002', total_cost: 0, operator: '李娜', remark: 'HER2 FISH-乳腺癌' },
    { id: 'OB-011', type: 'project', project_id: 'PRJ-MP-003', total_cost: 0, operator: '张伟', remark: 'ALK FISH-肺癌' },

    // === 特殊染色项目出库 ===
    { id: 'OB-012', type: 'project', project_id: 'PRJ-SS-001', total_cost: 0, operator: '张伟', remark: 'PAS染色-肾穿刺' },

    // === 细胞学项目出库 ===
    { id: 'OB-013', type: 'project', project_id: 'PRJ-CYTO-001', total_cost: 0, operator: '李娜', remark: 'TCT检测-宫颈癌筛查' },
    { id: 'OB-014', type: 'project', project_id: 'PRJ-CYTO-002', total_cost: 0, operator: '张伟', remark: '细针穿刺-甲状腺结节' },

    // === 非项目领用（调拨/报废） ===
    { id: 'OB-015', type: 'transfer', project_id: null, total_cost: 0, operator: '王坤强', remark: 'A区调至B区-库位整理' },
    { id: 'OB-016', type: 'scrap', project_id: null, total_cost: 0, operator: '王坤强', remark: '过期物料报废-HER2抗体' },
  ]
  ...
  const items = [
    ...
    // OB-010: FISH-HER2
    { outbound_id: 'OB-010', material_id: 'MAT-MP-008', batch_no: null, quantity: 1, unit: '盒', unit_cost: 6800 },

    // OB-011: FISH-ALK
    { outbound_id: 'OB-011', material_id: 'MAT-MP-009', batch_no: null, quantity: 1, unit: '盒', unit_cost: 7200 },
  ...
  for (const item of items) {
    ...
    insertItem.run(uuidv4(), item.outbound_id, item.material_id, item.batch_no, item.quantity, item.unit, item.unit_cost, totalCost, item.outbound_id.startsWith('OB-00') ? '张伟' : '王坤强', now)
  }
...
function seedStocktaking(db: any) {
  ...
  const records = [
    ...
    { id: 'ST-001', material_id: 'MAT-HE-001', system_stock: 10, actual_stock: 9, difference: -1, operator: '王坤强', remark: '日常损耗' },
    // 伊红染液 - 系统10瓶，实际10瓶（无差异）
    { id: 'ST-002', material_id: 'MAT-HE-002', system_stock: 10, actual_stock: 10, difference: 0, operator: '王坤强', remark: '账实相符' },
    // 无水乙醇 - 系统15瓶，实际14瓶（差异-1）
    { id: 'ST-003', material_id: 'MAT-HE-005', system_stock: 15, actual_stock: 14, difference: -1, operator: '王坤强', remark: '挥发损耗' },
    // 防脱载玻片 - 系统20盒，实际18盒（差异-2）
    { id: 'ST-004', material_id: 'MAT-GLASS-001', system_stock: 20, actual_stock: 18, difference: -2, operator: '王坤强', remark: '破损2盒' },
    // 丁腈手套 - 系统15盒，实际16盒（差异+1）
    { id: 'ST-005', material_id: 'MAT-LAB-010', system_stock: 15, actual_stock: 16, difference: 1, operator: '王坤强', remark: '盘盈1盒' },
    // CK抗体 - 系统3瓶，实际3瓶
    { id: 'ST-006', material_id: 'MAT-IHC-001', system_stock: 3, actual_stock: 3, difference: 0, operator: '王坤强', remark: '账实相符' },
  ]
...
function seedReturns(db: any) {
  ...
  const records = [
    { id: 'RT-001', material_id: 'MAT-HE-001', batch_no: 'DAKO-HE-20260320-B', quantity: 1, reason: '包装破损', operator: '王坤强' },
    { id: 'RT-002', material_id: 'MAT-GLASS-001', batch_no: 'LEICA-GL-20260508', quantity: 2, reason: '运输损坏', operator: '王坤强' },
  ]
...
function seedScraps(db: any) {
  ...
  const records = [
    { id: 'SC-001', material_id: 'MAT-IHC-004', batch_no: 'DAKO-IHC-20240501-EXP', quantity: 1, reason: '已过期（2025-05-01）', operator: '王坤强' },
    { id: 'SC-002', material_id: 'MAT-HE-003', batch_no: 'LEICA-HE-20260401', quantity: 1, reason: '开封后变质', operator: '王坤强' },
  ]
...
function seedSupplierReturns(db: any) {
  ...
  const records = [
    // pending: 待发货
    { id: 'SR-001', material_id: 'MAT-HE-001', quantity: 1, supplier_id: 'SUP-003', reason: 'quality_issue', refund_amount: 180, tracking_no: '', status: 'pending', operator: '王坤强', remark: '包装渗漏' },
    // shipped: 已发货
    { id: 'SR-002', material_id: 'MAT-GLASS-001', quantity: 2, supplier_id: 'SUP-003', reason: 'damaged', refund_amount: 360, tracking_no: 'SF1098236745', status: 'shipped', operator: '王坤强', remark: '运输破损' },
    // received: 已收货
    { id: 'SR-003', material_id: 'MAT-IHC-001', quantity: 1, supplier_id: 'SUP-001', reason: 'quality_issue', refund_amount: 1200, tracking_no: 'JD0078342195', status: 'received', operator: '王坤强', remark: '效期不足6个月' },
    // refunded: 已退款
    { id: 'SR-004', material_id: 'MAT-HE-005', quantity: 3, supplier_id: 'SUP-009', reason: 'quantity_mismatch', refund_amount: 75, tracking_no: 'YT3891027645', status: 'refunded', operator: '赵慧萍', remark: '实际到货少3瓶' },
    // cancelled: 已取消
    { id: 'SR-005', material_id: 'MAT-LAB-010', quantity: 1, supplier_id: 'SUP-010', reason: 'other', refund_amount: 0, tracking_no: '', status: 'cancelled', operator: '王坤强', remark: '与供应商协商换货' },
  ]
...
function seedOperationLogs(db: any) {
  ...
  const logs = [
    ...
    { user_id: 'USER-PRO', username: 'zhaohp', operation: '采购入库', description: '创建苏木素染液采购入库单 IB-20260511-001' },
    { user_id: 'USER-PRO', username: 'zhaohp', operation: '采购入库', description: '创建伊红染液采购入库单 IB-20260511-004' },
    { user_id: 'USER-PRO', username: 'zhaohp', operation: '采购入库', description: '创建IHC抗体批量采购入库（6笔）' },
    { user_id: 'USER-WHM', username: 'wangkq', operation: '库存盘点', description: '完成月度库存盘点，发现差异3笔' },
    { user_id: 'USER-TECH1', username: 'zhangwei', operation: '物料领用', description: 'HE染色项目领用-苏木素/伊红/载玻片' },
    { user_id: 'USER-TECH1', username: 'zhangwei', operation: '物料领用', description: 'IHC检测领用-广谱CK抗体' },
    { user_id: 'USER-TECH2', username: 'lina', operation: '物料领用', description: 'IHC检测领用-Ki-67抗体' },
    { user_id: 'USER-TECH2', username: 'lina', operation: '物料领用', description: 'TCT检测领用-液基保存液/载玻片' },
    { user_id: 'USER-WHM', username: 'wangkq', operation: '退货处理', description: '处理苏木素染液包装破损退货1瓶' },
    { user_id: 'USER-WHM', username: 'wangkq', operation: '报废处理', description: '报废过期IHC抗体（2025-05-01到期）' },
    { user_id: 'USER-DOC1', username: 'liuyf', operation: '出库审批', description: '审批通过NGS检测项目出库单' },
    { user_id: 'USER-DOC2', username: 'chenbo', operation: '出库审批', description: '审批通过FISH检测项目出库单' },
  ]
  ...
  for (const l of logs) {
    insert.run(uuidv4(), l.user_id, l.username, l.operation, l.description, '{}', '{}', '192.168.1.105', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36', now)
  }
