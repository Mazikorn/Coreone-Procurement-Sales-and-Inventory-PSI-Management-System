...
export default function CostAnalysis() {
  ...
  return (
    <div className="space-y-6">
      ...
      {page.activeTab === 'public-cost' && (
        <PublicCostPanel
          publicCost={page.stats.publicCost}
          totalCost={page.stats.totalCost}
          totalSamples={page.stats.totalSamples}
        />
      )}
      ...
      <CostExportModal
        ...
        sections={page.exportSections}
        onSectionsChange={page.setExportSections}
