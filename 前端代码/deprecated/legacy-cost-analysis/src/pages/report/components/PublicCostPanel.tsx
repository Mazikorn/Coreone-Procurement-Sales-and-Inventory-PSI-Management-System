...
export function PublicCostPanel({ publicCost, totalCost, totalSamples }: Props) {
  const ratio = totalCost > 0 ? `${((publicCost / totalCost) * 100).toFixed(1)}%` : '-'
      ...
      <div className="p-5 space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div className="p-4 bg-gray-50 rounded-lg">
            ...
            <div className="text-lg font-semibold text-gray-900">{totalSamples.toLocaleString()}</div>
          </div>
          <div className="p-4 bg-gray-50 rounded-lg">
            <div className="text-xs text-gray-500 mb-1">年度成本</div>
            <div className="text-lg font-semibold text-gray-900">{formatCurrency(publicCost)}</div>
          </div>
          <div className="p-4 bg-gray-50 rounded-lg">
            <div className="text-xs text-gray-500 mb-1">占总成本</div>
            <div className="text-lg font-semibold text-gray-900">{ratio}</div>
          </div>
          <div className="p-4 bg-gray-50 rounded-lg">
