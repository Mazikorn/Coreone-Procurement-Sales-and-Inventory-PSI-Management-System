              ...
              data.map((p, idx) => {
                ...
                return (
                  <tr key={p.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-right text-gray-600">{Number(p.ratio || 0).toFixed(1)}%</td>
                    ...
                    <td className="px-4 py-3 text-right">
                      {typeof p.changeRate === 'number' ? <ChangeBadge value={p.changeRate} /> : <span className="text-xs text-gray-400">-</span>}
                    </td>
