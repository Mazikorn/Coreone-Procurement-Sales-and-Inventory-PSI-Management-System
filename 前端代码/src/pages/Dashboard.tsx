...
import { Clock, AlertTriangle, Package, ShoppingCart, ClipboardCheck, Bell } from 'lucide-react'
import { useDashboardPage, formatCurrency, formatPercent } from './dashboard/hooks/useDashboardPage'
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {(stats.outOfStockCount || 0) > 0 && (
          <div className="flex items-center gap-3 p-3 rounded-lg bg-red-50">
            ...
            <div>
              <p className="text-lg font-bold text-red-600">{stats.outOfStockCount || 0}</p>
