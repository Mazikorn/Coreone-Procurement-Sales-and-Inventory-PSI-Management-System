...
export default function CostModelValidation() {
  ...
  const handleCalculate = async () => {
    ...
    try {
      ...
      const detail: any = bomDetail
      const materialCostPerSlide = detail?.materialCost || detail?.standardSlideCost || selectedBom?.materialCost || 0
      const feePerSlide = detail?.standardFeePerSlide || selectedBom?.standardFeePerSlide || 0
