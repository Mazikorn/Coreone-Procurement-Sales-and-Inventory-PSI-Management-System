...
describe('parseProjectImportRows', () => {
  ...
  it('导入前校验BOM是否存在启用、类型匹配且有核心物料', () => {
    const boms = [
      { id: 'bom-he-ok', type: 'he', materialCount: 1 },
      { id: 'bom-ihc', type: 'ihc', materialCount: 1 },
      { id: 'bom-empty', type: 'he', materialCount: 0 },
    ] as any
    ...
    expect(result.errors).toEqual([
      ...
      '第 4 行BOM类型与服务类型不一致：bom-ihc',
      '第 5 行BOM缺少核心物料：bom-empty',
    ])
  })
})
