...
import { BomBatchPreview } from './BomBatchPreview'
import { formatQuantity, collectBomMaterialIds, buildBomBatchPreviewRows } from './bomBatchPreviewUtils'
        ...
        <div className="p-6 space-y-4">
          ...
          {isBomOutbound ? (
            <div className="space-y-3">
              ...
              <BomBatchPreview rows={bomBatchPreviewRows} />
